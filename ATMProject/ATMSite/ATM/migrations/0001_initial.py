...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Pin_Change',
            fields=[
                ('Pin_Change_ID', models.AutoField(primary_key=True, serialize=False)),
                ('Previous_Pin', models.IntegerField()),
                ('New_Pin', models.IntegerField()),
                ('Transaction_ID', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='ATM.Transaction')),
            ],
        ),
        migrations.CreateModel(
            name='Phone_Change',
            fields=[
                ('Phone_Change_ID', models.AutoField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('Cash_Withdrawal_ID', models.AutoField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('Balance_Enquiry_ID', models.AutoField(primary_key=True, serialize=False)),
